        ...
        <div className='rounded-lg border border-gray-200 bg-white p-4'>
            <div className='flex items-center justify-between'>
                ...
                <div className='ml-4 flex items-center space-x-3'>
                    <span className='rounded-full bg-red-50 px-2 py-1 text-sm text-red-600'>
                        Blocked
                    </span>
                    <button
                        onClick={handleUnblock}
                        disabled={unblockMutation.isPending}
                        className='flex items-center justify-center rounded-md bg-green-50 px-3 py-2 text-sm font-medium text-green-600 transition-colors hover:bg-green-100 disabled:opacity-50'
                    >
