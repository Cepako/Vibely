...
export default function CreateEventModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Don't delete endTime since it's now required
                ...
                {formData.privacyLevel !== 'public' ? (
                    ...
                    <div className='space-y-2'>
                        ...
                        <p className='mb-3 text-sm text-slate-500'>
                            Even though this is a public event, you can still
                    ...
                    formData.maxParticipants <
                        ...
                        <div className='rounded-lg border border-red-200 bg-red-50 p-3'>
                            <p className='text-sm text-red-600'>
                                Cannot invite {formData.invitedFriends.length}{' '}
                                friends with a maximum of{' '}
                                {formData.maxParticipants} participants. Either
                                increase the maximum participants or reduce the
                    ...
                    formData.maxParticipants >=
                        ...
                        <div className='rounded-lg border border-amber-200 bg-amber-50 p-3'>
                            <p className='text-sm text-amber-600'>
                                You've selected {formData.invitedFriends.length}{' '}
                                friends, which with you as organizer reaches the
