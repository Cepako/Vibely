...
export const friendshipStatusType = pgEnum('friendship_status_type', [
    'pending',
    'accepted',
    'blocked',
]);
export const genderType = pgEnum('gender_type', ['male', 'female']);
export const notificationRelatedType = pgEnum('notification_related_type', [
    'posts',
    'comments',
    'friendships',
    'events',
...
export const participantStatusType = pgEnum('participant_status_type', [
    'invited',
    'going',
    'declined',
]);
export const postContentType = pgEnum('post_content_type', ['photo', 'video']);
export const privacyLevelType = pgEnum('privacy_level_type', [
    'public',
    'friends',
    'private',
]);
...
export const friendships = pgTable(
    ...
    (table) => [
        ...
        index('idx_friendships_user_id').using(
            'btree',
        ...
        unique('friendships_user_id_friend_id_key').on(
            table.userId,
            table.friendId
        ),
...
export const eventCategories = pgTable(
    ...
    (table) => [
        index('idx_event_categories_name').using(
            'btree',
...
export const postReactions = pgTable(
    ...
    (table) => [
        index('idx_post_reactions_post_id').using(
            'btree',
            table.postId.asc().nullsLast().op('int4_ops')
        ),
        index('idx_post_reactions_user_id').using(
            'btree',
            table.userId.asc().nullsLast().op('int4_ops')
        ),
        foreignKey({
        ...
        unique('post_reactions_post_id_user_id_key').on(
            table.postId,
            table.userId
        ),
    ]
...
export const conversationParticipants = pgTable(
    ...
    (table) => [
        index('idx_conversation_participants_conversation_id').using(
            'btree',
        ...
        unique('conversation_participants_conversation_id_user_id_key').on(
...
export const events = pgTable(
    ...
    (table) => [
        index('idx_events_category_id').using(
            'btree',
            table.categoryId.asc().nullsLast().op('int4_ops')
        ),
        index('idx_events_organizer_id').using(
            'btree',
            table.organizerId.asc().nullsLast().op('int4_ops')
        ),
        index('idx_events_privacy_level').using(
            'btree',
            table.privacyLevel.asc().nullsLast().op('enum_ops')
        ),
        index('idx_events_start_time').using(
            'btree',
...
export const eventParticipants = pgTable(
    ...
    (table) => [
        index('idx_event_participants_event_id').using(
            'btree',
            table.eventId.asc().nullsLast().op('int4_ops')
        ),
        index('idx_event_participants_status').using(
            'btree',
            table.status.asc().nullsLast().op('enum_ops')
        ),
        index('idx_event_participants_user_id').using(
            'btree',
            table.userId.asc().nullsLast().op('int4_ops')
        ),
        foreignKey({
        ...
        unique('event_participants_event_id_user_id_key').on(
            table.eventId,
            table.userId
        ),
    ]
...
export const interests = pgTable(
    ...
    (table) => [
        index('idx_interests_name').using(
            'btree',
            table.name.asc().nullsLast().op('text_ops')
        ),
...
export const posts = pgTable(
    ...
    (table) => [
        ...
        index('idx_posts_privacy_level').using(
            'btree',
            table.privacyLevel.asc().nullsLast().op('enum_ops')
        ),
...
export const conversations = pgTable(
    ...
    (table) => [
        index('idx_conversations_type').using(
            'btree',
...
export const messageAttachments = pgTable(
    ...
    (table) => [
        index('idx_message_attachments_message_id').using(
            'btree',
...
export const messages = pgTable(
    ...
    (table) => [
        ...
        index('idx_messages_sender_id').using(
            'btree',
...
export const userInterests = pgTable(
    ...
    (table) => [
        index('idx_user_interests_interest_id').using(
            'btree',
            table.interestId.asc().nullsLast().op('int4_ops')
        ),
        ...
        unique('user_interests_user_id_interest_id_key').on(
            table.userId,
            table.interestId
        ),
    ]
...
export const commentReactions = pgTable(
    ...
    (table) => [
        index('idx_comment_reactions_comment_id').using(
            'btree',
            table.commentId.asc().nullsLast().op('int4_ops')
        ),
        index('idx_comment_reactions_user_id').using(
            'btree',
            table.userId.asc().nullsLast().op('int4_ops')
        ),
        foreignKey({
